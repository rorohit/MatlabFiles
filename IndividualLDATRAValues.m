...
testlabledataDrowsy = csvread('LDAInvidualFinalLabelsDrowsy.csv',0,0,[0,0,599,22]);
testlabledataFresh = csvread('LDAInvidualFinalLabelsFresh.csv',0,0,[0,0,599,22]);
...
csvwrite('FinalDataLDAIndividual.csv',FinalData);
