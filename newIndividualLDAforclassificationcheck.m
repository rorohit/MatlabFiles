...
for iii = 1:8
    ...
    finallablecheck4 = [finallablecheck4;lablecheck];
    finallabledata4 = [finallabledata4;labledata];
...
%Correct Classification @ less than 30% is False Positive
    ...
    data1new = [data1new;classification length(ADATA12312) (classification*100/length(ADATA12312))]
    Information1 = [Information1;data1new];
end
