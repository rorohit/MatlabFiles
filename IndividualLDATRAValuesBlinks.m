testlabledataFresh = csvread('LDAFinalLabelBlinkIndividualF.csv',0,0,[0,0,10,22]);
testlabledataDrowsy = csvread('LDAFinalLabelBlinkIndividualD.csv',0,0,[0,0,10,22]);
...
csvwrite('FinalDataLDAIndividualBlink.csv',FinalData);
