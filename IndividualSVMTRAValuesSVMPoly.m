...
testlabledataDrowsy = csvread('SVMInvidualFinalLabelsDrowsySVMPoly.csv',0,0,[0,0,599,22]);
testlabledataFresh = csvread('SVMInvidualFinalLabelsFreshSVMPoly.csv',0,0,[0,0,599,22]);
...
csvwrite('FinalDataSVMIndividualPoly.csv',FinalData);
