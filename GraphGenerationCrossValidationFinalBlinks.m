...
FinalDataSVMCrossValidation = csvread('FinalDataSVMCrossValidationBlink.csv',0,0,[0,0,22,3]);
FinalDataLDACrossValidation = csvread('FinalDataLDACrossValidationBlink.csv',0,0,[0,0,22,3]);
FinalDataSVMIndividualSpectral = csvread('FinalDataSVMCrossValidation.csv',0,0,[0,0,22,3]);
...
set(gca,'fontsize',20);
axis([-inf,inf,0,100]);
saveas(gcf,'AccuracySVMCrossValidationBlinks.bmp');
...
set(gca,'fontsize',20);
axis([-inf,inf,0,100]);
saveas(gcf,'AccuracyLDACrossValidationBlinks.bmp');
...
saveas(gcf,'BoxPlotComarisionCrossValidationBlinks.bmp');
...
saveas(gcf,'BoxPlotComarisionCrossValidationBlinksandSpectral.bmp');
