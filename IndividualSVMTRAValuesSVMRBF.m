...
testlabledataDrowsy = csvread('SVMInvidualFinalLabelsDrowsySVMRBF.csv',0,0,[0,0,599,22]);
testlabledataFresh = csvread('SVMInvidualFinalLabelsFreshSVMRBF.csv',0,0,[0,0,599,22]);
...
csvwrite('FinalDataSVMIndividualRBF.csv',FinalData);
