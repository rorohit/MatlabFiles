testlabledataFresh = csvread('LDAFinalLabelBlinkCrossValidationF.csv',0,0,[0,0,54,22]);
testlabledataDrowsy = csvread('LDAFinalLabelBlinkCrossValidationD.csv',0,0,[0,0,54,22]);
...
csvwrite('FinalDataLDACrossValidationBlink.csv',FinalData);
