...
testlabledataDrowsy = csvread('SVMFinalLabelCheck1MinAggregation1.csv',3000,0,[3000,0,5999,22]);
testlabledataFresh = csvread('SVMFinalLabelCheck1MinAggregation1.csv',0,0,[0,0,2999,22]);
...
csvwrite('FinalDataSVMCrossValidation1.csv',FinalData);
