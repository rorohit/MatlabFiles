...
csvwrite('LDAFinalAccuracyBlinkIndividual.csv',FinalAccuracy);
csvwrite('LDAFinalLabelBlinkIndividualD.csv',FinaltestlabeldataD);
csvwrite('LDAFinalLabelBlinkIndividualF.csv',FinaltestlabeldataF);
...
ylabel('Percentages');
xlabel('Participants');
title('Individual LDA Results 80-20 Training & Testing');
